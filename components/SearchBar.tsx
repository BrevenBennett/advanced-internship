...
export default function SearchBar() {
  ...
  const duration = useSelector((state: RootState) => state.audioPlayer.duration)
            ...
            {results.map((result: any) => (
              ...
              >
                ...
                <figure className="search-book__image--wrapper">
                  <img src={result.imageLink} alt="" className="book__image" />
                </figure>
                <div>
                  ...
                  <div className="recommended__books--details">
                    ...
                    <div className="recommended__books--details-text">{duration}</div>
                  </div>
                </div>
              </a>
            ))}
